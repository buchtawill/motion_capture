...
#define IRPT_CTL_DEVID 		        XPAR_XSCUGIC_0_BASEADDR // XPAR_PS7_SCUGIC_0_DEVICE_ID
#define GPIO_DEVID			        XPAR_GPIO0_BASEADDR // XPAR_PS7_GPIO_0_DEVICE_ID
#define GPIO_IRPT_ID			    XPAR_PS7_GPIO_0_INTR
#define CAM_I2C_DEVID		        XPAR_I2C0_BASEADDR //XPAR_PS7_I2C_0_DEVICE_ID
#define CAM_I2C_IRPT_ID		        XPAR_PS7_I2C_0_INTR
#define VDMA_DEVID			        XPAR_AXI_VDMA_0_BASEADDR // XPAR_AXIVDMA_0_DEVICE_ID
#define VDMA_MM2S_IRPT_ID	        XPAR_FABRIC_AXI_VDMA_0_INTR // XPAR_FABRIC_AXI_VDMA_0_MM2S_INTROUT_INTR 
#define VDMA_S2MM_IRPT_ID	        XPAR_FABRIC_AXI_VDMA_0_INTR_1 // XPAR_FABRIC_AXI_VDMA_0_S2MM_INTROUT_INTR

...
namespace OV9281_cfg 
{
	...
	config_word_t const cfg_720p_60fps_[] =
	{
        ...
        //Removes vertical lines appearing under bright light
		{0x3618, 0x00},
		{0x3612, 0x59},
		{0x3708, 0x64},
		{0x3709, 0x52},
	...
	{   
		...
		//[4]=1 PLL root divider /2, [3:0]=5 PLL pre-divider /1.5
		{0x3037, 0x15},
		//[5:4]=00 PCLK root divider /1, [3:2]=00 SCLK2x root divider /1, 
		...
		//[7:5]=001 One lane mode, [4]=0 MIPI HS TX no power down, 
        //[3]=0 MIPI LP RX no power down, [2]=1 MIPI enable, 
        //[1:0]=10 Debug mode; Default=0x58
		{0x300e, 0x25},
		...
		//[7:4]=0x1 horizontal odd subsample increment, 
        //[3:0]=0x1 horizontal even subsample increment
		{0x3814, 0x11},
		//[7:4]=0x1 vertical odd subsample increment, 
        //[3:0]=0x1 vertical even subsample increment
		{0x3815, 0x11},

		//[2]=0 ISP mirror, [1]=0 sensor mirror, 
        //[0]=0 no horizontal binning
		{0x3821, 0x00},

		//little MIPI shit: global timing unit, 
        //period of PCLK in ns * 2(depends on # of lanes)
		{0x4837, 28}, // 1/84M*2
	...
	config_word_t const cfg_init_[] =
	{
        ...
        //[1:0]=10 Debug mode; Default=0x58
		{0x300e, 0x45},
		//[5]=0 Clock free running, [4]=1 Send line short packet, 
        //[3]=0 Use lane1 as default, [2]=1 MIPI bus LP11 when no packet; 
        //Default=0x04
		{0x4800, 0x14},
		{0x302e, 0x08},

...
# -----------------------------------------------------------------------------------
# Fix vitis 2024.1 ps7 init bug
# -----------------------------------------------------------------------------------
launch_json_path = os.path.join(workspace_path, APP_NAME, '_ide/.theia/launch.json')

with open(launch_json_path, 'r') as f:
    launch_json = json.load(f)

config_ptr = launch_json['configurations'][0]['targetSetup']['zynqInitialization']['usingPs7Init']
config_ptr['ps7InitTclFile'] = config_ptr['ps7InitTclFile'].rsplit('/', 1)[0] + '/ps7_init.tcl'

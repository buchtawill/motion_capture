...
\
  ...
  # Create instance: mocap_wrapper_0, and set properties
  set block_name mocap_wrapper
  set block_cell_name mocap_wrapper_0
  if { [catch {set mocap_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $mocap_wrapper_0 eq "" } {
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_vdma_0_M_AXI_S2MM] [get_bd_intf_pins axi_vdma_0/M_AXI_S2MM] [get_bd_intf_pins system_ila_0/SLOT_3_AXI]
  connect_bd_intf_net -intf_net frame_rate_counter_0_m_axis [get_bd_intf_pins mocap_wrapper_0/m_axis] [get_bd_intf_pins axi_vdma_0/S_AXIS_S2MM]
connect_bd_intf_net -intf_net [get_bd_intf_nets frame_rate_counter_0_m_axis] [get_bd_intf_pins mocap_wrapper_0/m_axis] [get_bd_intf_pins system_ila_0/SLOT_4_AXIS]
  connect_bd_intf_net -intf_net mipi_csi2_rx_subsyst_0_video_out1 [get_bd_intf_pins mipi_csi2_rx_subsyst_0/video_out] [get_bd_intf_pins mocap_wrapper_0/s_axis]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps8_0_axi_periph_M00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_2_AXI]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins ps8_0_axi_periph/M03_AXI] [get_bd_intf_pins mocap_wrapper_0/s_axi]
connect_bd_intf_net -intf_net [get_bd_intf_nets ps8_0_axi_periph_M03_AXI] [get_bd_intf_pins ps8_0_axi_periph/M03_AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  ...
  assign_bd_address -offset 0xA0011000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mocap_wrapper_0/s_axi/reg0] -force
